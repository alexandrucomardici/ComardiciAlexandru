...
<head>
  ...
  <title>Black Friday - MotoParts.ro</title>
...
<!-- === BANNER CLICKBAIT BLACK FRIDAY === -->
<div class="blackfriday-banner">
  🔥 BLACK FRIDAY EXPLOZIV 🔥 Reduceri de până la <strong>65%</strong> la toate categoriile!  
  <a href="#oferte" class="banner-btn">Vezi ofertele 👇</a>
</div>
...
<div class="container" id="oferte">
  <aside class="sidebar"> <ul>
    <h2>🔥 Oferte Black Friday</h2>
    <ul>
      <li>Reduceri masive la toate categoriile</li>
      <li>Până la -65% la piese și accesorii</li>
      <li>Stoc limitat!</li>
      <li>Promoțiile sunt valabile până la epuizarea stocului</li>
    </ul>
    </ul>
  </aside>
  ...
  <div class="main-content">
    <div class="top-products">
      <h2>🎯 Oferte speciale de Black Friday</h2>
      <p style="text-align:center; font-size:1.1em; color:#ff9800; font-weight:bold;">Prinde cele mai mari reduceri ale anului!</p>
